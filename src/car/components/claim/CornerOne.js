...
class CornerOne extends Component {
  constructor(props) {
    super(props);
    this.state = {
    };
    ...
    return (
      	<View style={css.ct}>
			...
			<View style={{flexDirection: 'row', alignItems: 'center'}}>
				<Text style={css.txt}>Góc 1</Text>
				{
					corner.IMAGE_1.reason ?
			...
			{
				corner.IMAGE_1.reason ? 
					<Text style={[css.txt, {color: '#5c5c5c', maxWidth: 80}]}>{corner.IMAGE_1.reason}</Text>
				: null
			}
      	</View>
    );
...
export default connect(mapStateToProps)(CornerOne);
